...
$authorized = json_decode(file_get_contents('Discord-OAuth2/dicts/authorized.json'), true);
...
if (!in_array($ip, $authorized)) {
    header("Location: /authorize?map&lat=".$startingLat."&lon=".$startingLng);
} else {
    $authorized = array_values(array_diff($authorized, array($ip)));
    file_put_contents("Discord-OAuth2/dicts/authorized.json", json_encode($authorized, JSON_PRETTY_PRINT));
}

?> <!DOCTYPE html><html lang="<?= $locale ?>"><head><meta charset="utf-8"><title><?= $title ?></title><meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,minimum-scale=1,user-scalable=no,minimal-ui"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black"><meta name="apple-mobile-web-app-title" content="PokeMap"><meta name="mobile-web-app-capable" content="yes"><meta name="theme-color" content="#3b3b3b"><link rel="shortcut icon" href="static/appicons/favicon.ico" type="image/x-icon"><link rel="apple-touch-icon" href="static/appicons/114x114.png" sizes="57x57"><link rel="apple-touch-icon" href="static/appicons/144x144.png" sizes="72x72"><link rel="apple-touch-icon" href="static/appicons/152x152.png" sizes="76x76"><link rel="apple-touch-icon" href="static/appicons/114x114.png" sizes="114x114"><link rel="apple-touch-icon" href="static/appicons/120x120.png" sizes="120x120"><link rel="apple-touch-icon" href="static/appicons/144x144.png" sizes="144x144"><link rel="apple-touch-icon" href="static/appicons/152x152.png" sizes="152x152"><link rel="apple-touch-icon" href="static/appicons/180x180.png" sizes="180x180"> <?php if ($gAnalyticsId != "") {
        ...
        ?> <a href="#stats" id="statsToggle" class="statsNav" style="float: right"><span class="label">Stats</span></a></header><nav id="nav"><div id="nav-accordion"><h3>Marker Settings</h3><div> <?php if (!$noPokemon) {
                ...
                } ?> </div> <?php if (!$noSearchLocation || !$noStartMe || !$noStartLast || !$noFollowMe) {
